package com.cn.climax.wisdomparking.widget.bulletinboard;
...
public class TipView extends FrameLayout {
    ...
    /**  默认字体颜色  */
    private static final String DEFAULT_TEXT_COLOR = "#454545";
    /**  默认字体大小  dp  */
    ...
    private void initTipFrame() {
        head_boy = loadDrawable(R.drawable.icon_notice_black);
        head_girl = loadDrawable(R.drawable.icon_notice_black);
    ...
    public interface OnClickTipListener{
        void click(BulletinResponse response);
    }
    ...
    private Drawable loadDrawable(int ResId) {
        ...
        drawable.setBounds(0,  0, drawable.getMinimumWidth() - 56,  drawable.getMinimumWidth() - 56);
        return drawable;
    }
