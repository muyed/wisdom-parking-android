...
public class ProgressBarCircularIndeterminate extends RelativeLayout {
    ...
    private void drawSecondAnimation(Canvas canvas) {
        ...
        temp.drawCircle(getWidth() / 2, getHeight() / 2, (getWidth() / 2) - DensityUtil.dip2px(4, getResources()), transparentPaint);
    ...
    private void drawFirstAnimation(Canvas canvas) {
        if (radius1 < getWidth() / 2) {
            ...
            if (count >= 50) {
                ...
                radius2 = (radius2 >= getWidth() / 2 - DensityUtil.dip2px(4, getResources())) ?
                        (float) getWidth() / 2 - DensityUtil.dip2px(4, getResources()) : radius2 + 1;
            }
            temp.drawCircle(getWidth() / 2, getHeight() / 2, radius2, transparentPaint);
            canvas.drawBitmap(bitmap, 0, 0, new Paint());
            if (radius2 >= getWidth() / 2 - DensityUtil.dip2px(4, getResources())) count++;
    ...
    private void setAttributes(AttributeSet attrs) {
        setMinimumWidth(DensityUtil.dip2px(32, getResources()));
        setMinimumHeight(DensityUtil.dip2px(32, getResources()));
        ...
        setMinimumHeight(DensityUtil.dip2px(3, getResources()));
    }
