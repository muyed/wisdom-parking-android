...
public class ACheckBox extends View implements Checkable {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.ACheckBox);
            mStrokeWidth = (int) array.getDimension(R.styleable.ACheckBox_stroke_width, dip(mStrokeWidth));
            mStrokeColor = array.getColor(R.styleable.ACheckBox_stroke_color, mStrokeColor);
            mCircleColor = array.getColor(R.styleable.ACheckBox_circle_color, Color.WHITE);
            checked = array.getBoolean(R.styleable.ACheckBox_checked, false);
            array.recycle();
        } else {
    ...
    public interface OnCheckedChangeListener {
        void onChange(ACheckBox view, boolean checked);
    }
}
