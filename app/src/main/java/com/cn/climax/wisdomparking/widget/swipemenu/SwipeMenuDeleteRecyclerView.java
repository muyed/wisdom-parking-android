 ...
 */
public class SwipeMenuDeleteRecyclerView extends RecyclerView {

    private Rect mTouchFrame;

    public SwipeMenuDeleteRecyclerView(Context context) {
        this(context, null);
    }

    public SwipeMenuDeleteRecyclerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SwipeMenuDeleteRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
