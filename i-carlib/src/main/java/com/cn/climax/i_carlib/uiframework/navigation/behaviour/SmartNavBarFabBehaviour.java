package com.cn.climax.i_carlib.uiframework.navigation.behaviour;
 ...
 * Class description
 */
public class SmartNavBarFabBehaviour extends CoordinatorLayout.Behavior<FloatingActionButton> {

    ViewPropertyAnimatorCompat mFabTranslationYAnimator;
//    @SmartNavigationBar.FabBehaviour
...
//    public SmartNavBarFabBehaviour() {
//        mFabBehaviour = SmartNavigationBar.FAB_BEHAVIOUR_TRANSLATE_AND_STICK;
//    }
    ///////////////////////////////////////////////////////////////////////////
    // Dependencies setup
    ///////////////////////////////////////////////////////////////////////////
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, FloatingActionButton child, int layoutDirection) {
        ...
        updateFabTranslationForSmartNavigationBar(parent, child, null);
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, FloatingActionButton child, View dependency) {
        if (isDependent(dependency)) {
            updateFabTranslationForSmartNavigationBar(parent, child, dependency);
            return false;
        }
    ...
    private boolean isDependent(View dependency) {
        return dependency instanceof SmartNavigationBar || dependency instanceof Snackbar.SnackbarLayout;
    }
    ...
    private void updateFabTranslationForSmartNavigationBar(CoordinatorLayout parent, FloatingActionButton fab, View dependency) {

        float snackBarTranslation = getFabTranslationYForSnackBar(parent, fab);
        float[] bottomBarParameters = getFabTranslationYForSmartNavigationBar(parent, fab);
...
//        if (mFabBehaviour == SmartNavigationBar.FAB_BEHAVIOUR_DISAPPEAR) {
//            if (targetTransY == 0) {
//                fab.hide();
//            } else {
//                fab.show();
...
//        }
    ...
    private float[] getFabTranslationYForSmartNavigationBar(CoordinatorLayout parent,
        ...
        for (int i = 0, z = dependencies.size(); i < z; i++) {
            ...
            if (view instanceof SmartNavigationBar) {
