...
public class BootstrapDropDown extends AwesomeTextView implements View.OnClickListener, RoundableView, OutlineableView, PopupWindow.OnDismissListener {
    ...
    private static final String TAG = "com.cn.tufusi.formylove.widget.bootstrap.BootstrapDropDown";
    private static final String KEY_DIRECTION = "com.cn.tufusi.formylove.widget.bootstrap.BootstrapDropDown.EXPAND_DIRECTION";
