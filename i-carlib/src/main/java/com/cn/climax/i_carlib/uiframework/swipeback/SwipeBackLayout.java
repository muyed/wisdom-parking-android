package com.cn.climax.i_carlib.uiframework.swipeback;
...
/**
 * author：leo on 2016/11/23 20:47
...
public class SwipeBackLayout extends FrameLayout {
    ...
    private boolean mEnable = true; //默认允许左滑退出
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SwipeBackLayout, defStyleAttr,
     ...
     * callback's
     * {@link com.cn.smart.i_carlib.uiframework.swipeback.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.cn.smart.i_carlib.uiframework.swipeback.ViewDragHelper.Callback#onEdgeDragStarted(int,
     * int)}
