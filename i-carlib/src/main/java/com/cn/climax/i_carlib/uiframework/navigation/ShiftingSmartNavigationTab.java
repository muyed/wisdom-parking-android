 ...
 * Class description
 */
class ShiftingSmartNavigationTab extends SmartNavigationTab {

    public ShiftingSmartNavigationTab(Context context) {
        super(context);
    }

    public ShiftingSmartNavigationTab(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ShiftingSmartNavigationTab(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public ShiftingSmartNavigationTab(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
