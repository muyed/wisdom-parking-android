...
public class BootstrapButton extends AwesomeTextView
        implements BootstrapSizeView, OutlineableView, RoundableView, ButtonModeView, BadgeContainerView, BootstrapBadgeView {

    /**
     * instances of this can be used with .setOnCheckedChangedLisener to notify you when the state of a radio, toggle or checkbox button has changed.
     */
