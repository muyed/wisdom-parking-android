...
/**
 * author：leo on 2017/3/3 15:33
 * email： leocheung4ever@gmail.com
 * description: Holds and manage data for badges
...
public class BadgeItem {
    ...
    private void refreshDrawable() {
        if (isWeakReferenceValid()) {
            TextView textView = mTextViewRef.get();
            textView.setBackgroundDrawable(SmartNavigationHelper.getBadgeDrawable(this, textView.getContext()));
        }
    }
