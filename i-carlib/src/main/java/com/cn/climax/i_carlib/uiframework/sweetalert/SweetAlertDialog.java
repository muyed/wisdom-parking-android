package com.cn.climax.i_carlib.uiframework.sweetalert;
...
public class SweetAlertDialog extends Dialog implements View.OnClickListener {
    ...
    public SweetAlertDialog(Context context, int alertType) {
        ...
        mSuccessBowAnim = OptAnimationLoader.loadAnimation(getContext(), R.anim.sweet_success_bow_rotate);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sweet_dialog_alert);
    ...
    /**
     * 真正的Dialog.cancel()方法将会被异步委托在动画完成之后
     */
    @Override
    public void cancel() {
