...
public class StringUtil {
    ...
    public static boolean isUrlStr(String str) {
        ...
        String expression = "((http|ftp|https)://)(([a-zA-Z0-9\\._-]+\\.[a-zA-Z]{2,6})|([0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}))(:[0-9]{1,4})*(/[a-zA-Z0-9\\&%_\\./-~-]*)?";
    ...
    //"user_id":"72057594037927991"   seller_id=16777286
    public static boolean isErWeiCode(String str) {
        if (str.split(",") == null || (str.split(",") != null && str.split(",").length != 2))
            return false;
        List<String> strList = Arrays.asList(str.split(","));
        return strList.size() == 2 && isDigit(strList.get(0)) && isDigit(strList.get(1));
    }
    ...
    public static String hideIDNo(String str) {
        String result = "";
        try {
            result = str.substring(0, 4) + "**********" + str.substring(str.length() - 4);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return result;
    ...
    public static Boolean isEmail(String str) {
        ...
        String expr = "^[a-zA-Z0-9_-]+@[a-zA-Z0-9_-]+(\\.[a-zA-Z0-9_-]+)+$";
        if (str.matches(expr)) {
            isEmail = true;
        }
        return isEmail;
    ...
    public static String subNumnic(String number) {
        String subStr = number;
        if (number.length() > 4) {
            subStr = number.substring(0, number.length() - 3) + "." + number.substring(number.length() - 3) + "w";
        }
        return subStr;
    }

    //保留两位小数
    public static String RD(Object o) {
