...
/**
 * author：leo on 2017/3/3 15:32
 * email： leocheung4ever@gmail.com
 * description: 导航栏页签
 * what & why is modified:
 */

public class SmartNavigationTab extends FrameLayout {
    ...
    public SmartNavigationTab(Context context) {
        super(context);
        init();
    }

    public SmartNavigationTab(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public SmartNavigationTab(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public SmartNavigationTab(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
