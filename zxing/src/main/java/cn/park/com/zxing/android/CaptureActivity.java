package cn.park.com.zxing.android;
...
import cn.park.com.zxing.decode.DecodeImgCallback;
import cn.park.com.zxing.decode.DecodeImgThread;
import cn.park.com.zxing.decode.ImageUtil;
import cn.park.com.zxing.view.ViewfinderView;
...
public class CaptureActivity extends AppCompatActivity implements SurfaceHolder.Callback, View.OnClickListener {
    ...
    public void switchFlashImg(int flashState) {
        ...
        if (flashState == Constant.FLASH_OPEN) {
            flashLightIv.setBackgroundResource(R.drawable.ic_open);
        } else {
            flashLightIv.setBackgroundResource(R.drawable.ic_close);
        }
